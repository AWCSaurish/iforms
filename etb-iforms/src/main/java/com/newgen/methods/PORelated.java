...
import com.newgen.dto.POConditionBean;
...
public class PORelated {
	public ArrayList<POConditionBean> getConditions(String filter) {
		System.out.println("inside pocondition");
		POConditionBean conditionbean = null;
		General objGeneral = new General();
		ArrayList<POConditionBean> list = new ArrayList<>();
		String outputjson = objGeneral.poPullRequest(filter, objGeneral.conditionurl);
		...
		try {
			...
			for (int i = 0; i < arr.length(); i++) {
				...
				conditionbean = new POConditionBean();
				// if
				// ((arr.getJSONObject(i).optString("ConditionType").equalsIgnoreCase("ZAPC")))
				// {
				System.out.println("in Cond");
				conditionbean.setPoNumber(arr.getJSONObject(i).optString("PoNumber"));
				conditionbean.setDocDate(arr.getJSONObject(i).optString("DocDate"));
				conditionbean.setPoType(arr.getJSONObject(i).optString("PoType"));
				conditionbean.setVendor(arr.getJSONObject(i).optString("Vendor"));
				conditionbean.setConditionDoc(arr.getJSONObject(i).optString("ConditionDoc"));
				conditionbean.setConditionDocItem(arr.getJSONObject(i).optString("ConditionDocItem"));
				conditionbean.setConditionType(arr.getJSONObject(i).optString("ConditionType"));
				conditionbean.setDescription(arr.getJSONObject(i).optString("Description"));
				conditionbean.setPercentage(arr.getJSONObject(i).optString("Percentage"));
				conditionbean.setConditionValue(arr.getJSONObject(i).optString("ConditionValue"));
				conditionbean.setCalculationType(arr.getJSONObject(i).optString("CalculationType"));
				conditionbean.setCurrency(arr.getJSONObject(i).optString("Currency"));
				conditionbean.setExchangeRate(arr.getJSONObject(i).optString("ExchangeRate"));
				conditionbean.setMessage(arr.getJSONObject(i).optString("Message"));
